        ...
        <>
            ...
            <section className="service-inner-section1">
                ...
                <Row>
                    ...
                    <div className="d-flex align-items-center">
                        <h3 className="h3 secondary-text-color">Service</h3>
                    </div>

                    <h3 className="h1">Defi development</h3>

                    <p>
                        Our NFT development process provides high customization
                        freedom and allows you to become a frontrunner in the NFT
                        field by availing of the services of our NFT development
                        company.
                    </p>
                ...
                <Container>
                    ...
                    <Col lg={{ span: 6, offset: 1 }}>
                        ...
                        <li>
                            ...
                            We can help you apply this technology to drive your
                        ...
                        <li>
                            ...
                            aspirations, followed by a practical application of
                            blockchain innovation. The conversation grows as new
                            opportunities come to light along the way.{" "}
                        </li>

                        <li>
                            {" "}
                            As the leading independent technology organization, we
                            integrate alliances, partnerships, and leaders from every
                            aspect of the blockchain ecosystem. The goal? To bring the
                            right combination of capabilities to your unique
            ...
            <section className="service-inner-section3 py-xl-5 py-4">
                ...
                <Row>
                    ...
                    <h2 className="h2"> Our wide range of service include </h2>
                    </Col>
            ...
            <section className="service-inner-section4 py-5">
                ...
                <Row>
                    ...
                    <p>
                        Blockchain for business uses a shared and immutable ledger
                        that can only be accessed by members with permission. Network
                        members control what information each organization or member
                        may see, and what actions each can take. Blockchain is
                        sometimes called a trustless network not because business
                        partners don’t trust each other, but because they don’t have
                        to.
                    </p>
                    </Col>
