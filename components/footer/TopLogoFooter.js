            ...
            <Row className="py-md-5 py-4">
                <Col xl={12} lg={12} md={12} sm={6} xs={12} className="text-md-center mb-xl-5 pb-xl-5 mb-md-4 mb-3 pb-md-3 ">
                    ...
                    <div className="social-icons">
                        <a href="#" className="mx-3"><Image src="/icons/facebook.svg"  alt="..."/></a>
                        <a href="#" className="mx-3"><Image src="/icons/instagram.svg"  alt="..."/></a>
                        <a href="#" className="mx-3"><Image src="/icons/twitter.svg"  alt="..."/></a>
                        <a href="#" className="mx-3"><Image src="/icons/youtube.svg" alt="..." /></a>
                        <a href="#" className="mx-3"><Image src="/icons/wordpress.svg" alt="..."/></a>
                    </div>
                </Col>
